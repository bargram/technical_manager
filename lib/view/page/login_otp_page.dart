            ...
            SliverFillRemaining(
                ...
                child:Column(
                  children: [
                    ...
                    Row(children: [SizedBox(width:widthUtil(context, 0.05),),Expanded(child: Text(SharedStrings.phoneNumberValidationHint, style: smallTextStyle, textAlign:TextAlign.start,))]),
                    SizedBox(height:heightUtil(context, 0.075),),
                    LoginPageConfirmOtpButton(),
