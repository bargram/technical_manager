...
class RegisterCheckListPageDismissItemButton extends StatelessWidget {

  RegisterCheckListItem item;
  RegisterCheckListPageDismissItemButton(this.item);
  ...
  final Color selectedWidgetColor = MyColors.red;
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GestureDetector(
        onTap: ()async{
          RegisterCheckListModel.updateItem(item, false);
        },
        child: Container(
            ...
            decoration: BoxDecoration(
              color: item.approveStatus == false || item.approveStatus == null? selectedWidgetColor: unselectedWidgetColor,
              borderRadius: BorderRadius.circular(widgetBorderRadius),
            ),
            child: Center(
                child: Text(
                  SharedStrings.dismiss2,
                  style: textStyle,
                )
            )
        ),
