...
import 'package:bargram_technical_manager/view/widget/register_check_list_page/register_check_list_page_fire_extinguisher_confitm_button.dart';
...
class RegisterCheckListPageFireExtinguisherCard extends StatelessWidget {

  RegisterCheckListItem item;
  RegisterCheckListPageFireExtinguisherCard(this.item);
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                child: Text(
                  SharedStrings.endOFireExtinguisherValidationDate,
                  style: greyTextStyle,
                  textAlign:TextAlign.start,
                ),
              ),
              Expanded(
                child: GestureDetector(
                  onTap: ()async{
                    ...
                    RegisterCheckListModel.endOFireExtinguisherValidationDateController.text = '${pickedDate.toJDate().year}/${pickedDate.toJDate().month}/${pickedDate.toJDate().day}';
                    RegisterCheckListModel.setEndOFireExtinguisherValidation(pickedDate);
                  },
                  child: UnderlineGreyTextField(
                    textEditingController: RegisterCheckListModel.endOFireExtinguisherValidationDateController,
                    label: null,
                    enabled: false,
                    isNumeric: false,
                  ),
          ...
          Row(
            ...
            children: [
              RegisterCheckListPageFireExtinguisherConfirmItemButton(
                  item,
              ),
