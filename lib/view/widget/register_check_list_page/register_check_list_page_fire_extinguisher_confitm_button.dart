...
class RegisterCheckListPageFireExtinguisherConfirmItemButton extends StatelessWidget {

  RegisterCheckListItem item;
  RegisterCheckListPageFireExtinguisherConfirmItemButton(this.item);
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: GestureDetector(
        onTap: ()async{
          if(RegisterCheckListModel.endOFireExtinguisherValidationDateController.text == '' || RegisterCheckListModel().endOFireExtinguisherValidation == null){
            alert(context:context, title:SharedStrings.validationError, message:'${SharedStrings.endOFireExtinguisherValidationDate} ${SharedStrings.enterText}', isError:true);
            return;
          }
