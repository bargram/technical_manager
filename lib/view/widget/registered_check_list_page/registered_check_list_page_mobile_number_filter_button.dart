...
class RegisteredCheckListPageMobileNumberFilterButton extends StatelessWidget {
    ...
    return Container( //when not tapped on container , close state
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: ()async{
              RegisteredCheckListModel().mobileNumberFilterController.text = '';
              RegisteredCheckListModel.removeFromActiveFiltersList(FilterType.mobileNumber);
