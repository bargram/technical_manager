...
class RegisteredCheckListPageNationalCodeFilterButton extends StatelessWidget {
  //////////////////////////////Widget Styles///////////////////////////////////
    ...
    return Container( //when not tapped on container , close state
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: ()async{
              RegisteredCheckListModel().nationalCodeFilterController.text = '';
              RegisteredCheckListModel.removeFromActiveFiltersList(FilterType.nationalCode);
