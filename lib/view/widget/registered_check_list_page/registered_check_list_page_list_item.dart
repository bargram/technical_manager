...
//////////////////////////////Widget Styles///////////////////////////////////
  ...
  final TextStyle blueBoldTextStyle = TextStyle(
      fontSize: ScreenUtil().setSp(14),
      color: MyColors.deepBlue,
      fontWeight: FontWeight.bold);
  final TextStyle redBoldTextStyle = TextStyle(
      fontSize: ScreenUtil().setSp(14),
      color: MyColors.red,
      fontWeight: FontWeight.bold);
  final TextStyle greenBoldTextStyle = TextStyle(
      fontSize: ScreenUtil().setSp(14),
  ...
  final TextStyle blackBoldTextStyle = TextStyle(
      fontSize: ScreenUtil().setSp(14),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(color: widgetColor, boxShadow: const [
        BoxShadow(
        ...
        children: [
          Row(
            children: [
              Expanded(
                  child: Text(
                '${SharedStrings.id} : ${checkList.id}',
                style: blueBoldTextStyle,
                textAlign: TextAlign.start,
              )),
              Expanded(
                  child: Text(
                '${SharedStrings.status} : ${checkList.status == CheckListStatus.CONFIRM ? SharedStrings.confirm : checkList.status == CheckListStatus.PENDING ? SharedStrings.pending : SharedStrings.rejected}',
                style: blueBoldTextStyle,
          ...
          Row(
            children: [
              ...
              Expanded(
                  child: Text(
                '${SharedStrings.fireCapsuleDate} : ${checkList.capsuleDate}',
          ...
          Row(
            children: [
              ...
              Expanded(
                  child: Text(
                '${SharedStrings.technicalLicenseDate} : ${checkList.technicalLicenseDate}',
                style: blackTextStyle,
                textAlign: TextAlign.start,
              )),
            ],
          ...
          Row(
            children: [
              ...
              Expanded(
                  child: Text(
                '${SharedStrings.ipAddress} : ${checkList.ip}',
                style: blackTextStyle,
                textAlign: TextAlign.start,
              )),
            ],
          ...
          Row(
            children: [
              ...
              Expanded(
                  child: Text(
                '${SharedStrings.driverName} : ${checkList.driverName}',
                style: blackTextStyle,
                textAlign: TextAlign.start,
              )),
            ],
          ...
          Row(
            children: [
              ...
              Expanded(
                  child: Text(
                '${SharedStrings.checkListCreatedDate} : ${checkList.createdDate}',
                style: blackTextStyle,
                textAlign: TextAlign.start,
              )),
            ],
          ...
          checkList.car == null
              ...
              : Row(
                  children: [
                    ...
                    Plaque(
                        checkList.car!.plaquePart3,
                        checkList.car!.plaquePart2,
                        checkList.car!.plaquePart1,
                        checkList.car!.plaquePart4)
                  ],
                ),

          checkList.trackingCode == 'null'
              ? Container()
              : SizedBox(
                  height: heightUtil(context, 0.01),
                ),
          checkList.trackingCode == 'null'
              ...
              : Row(
                  children: [
                    ...
                    Expanded(
                        child: Text(
                      '${SharedStrings.trackingCode} : ${checkList.trackingCode}',
                      style: blackTextStyle,
                      textAlign: TextAlign.start,
                    )),
                  ],
          ...
          Row(
            ...
            children: [
              ...
              //     child: Image.network(
              //       'https://s6.uupload.ir/files/61808034_gy3l.jpg',
              //       fit: BoxFit.fill,
              //     ),
              //   ),
              // )
          ...
          DownloadingImage(
              imagePath: checkList.signatureUrl,
              imageHeight: widthUtil(context, imageWidth),
              imageWidth: widthUtil(context, imageWidth)),
          ...
          Row(
            children: [
              ...
              checkList.trackingCode != 'null' ||
                      checkList.status != CheckListStatus.CONFIRM
                  ? Container()
