...
class RegisteredCheckListPageDateFilterButton extends StatelessWidget {
    ...
    return Container( //when not tapped on container , close state
      ...
      child: Row(
        ...
        children: [
          ...
          GestureDetector(
            onTap: ()async{
              RegisteredCheckListModel().startDateFilterController.text = '';
              RegisteredCheckListModel().endDateFilterController.text = '';
              RegisteredCheckListModel.removeFromActiveFiltersList(FilterType.date);
