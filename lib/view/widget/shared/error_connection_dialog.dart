...
Future errorConnectionDialog({
  ...
  const double widgetHorizontalMargin = 0.1;
  ...
  final TextStyle whiteTextStyle = TextStyle(fontFamily: FontsManager.vazir, fontSize: ScreenUtil().setSp(16),color:Colors.white, fontWeight:FontWeight.bold);
  return showDialog(
      context: context,
      builder: (context) {
        return
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(child: _NoButton(onReturn)),
                              SizedBox(width:widthUtil(context, 0.025),),
                              Expanded(child: _YesButton(onRetry)),
                              SizedBox(width:widthUtil(context, 0.05),),
                            ],
                          ),
