...
class UnderlineBlueTextField extends StatelessWidget {
  ...
  bool? enabled;
  String? suffixText;
  UnderlineBlueTextField({required this.textEditingController, required this.label, required this.isNumeric,
    this.lines,
    this.maxLength,
    this.hasShadow,
    this.enabled,
  ...
  final TextStyle textStyle = TextStyle(fontSize:ScreenUtil().setSp(14), color:MyColors.deepBlue, fontFamily:FontsManager.vazir, fontWeight:FontWeight.bold);

  final Color fillFieldColor = MyColors.blue.withOpacity(0.15);
