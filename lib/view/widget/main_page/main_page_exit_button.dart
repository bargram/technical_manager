import 'dart:convert';
import 'package:bargram_technical_manager/database/dbs_manager.dart';
import 'package:bargram_technical_manager/utils/colors.dart';
import 'package:bargram_technical_manager/view/page/login_otp_page.dart';
...
class MainPageExitButton extends StatefulWidget {

  @override
  State<MainPageExitButton> createState() => _MainPageExitButtonState();
}

class _MainPageExitButtonState extends State<MainPageExitButton> {
  ...
  final Color widgetColor = MyColors.red;
