...
class GetCheckListTrackingCodeController extends GetxController{
  ...
  static setLoadingState(value){
    ...
    changeNotifier ?
    Get.find<GetCheckListTrackingCodeController>().loadingState = value:
    _loadingState = value;
  }
  ...
  static Future run({
    ...
    GeneralServiceResult result = await CheckListService.getTrackingCode(
      id:id,
    );
