...
import 'get_driver_controller.dart';




class RegisterCheckListCarController extends GetxController{
  ...
  static setLoadingState(value){
    ...
    changeNotifier ?
    Get.find<RegisterCheckListCarController>().loadingState = value:
    _loadingState = value;
  }
  ...
  static Future run({
    ...
    GeneralServiceResult result = await CheckListService.registerCheckListCar(
      id:driverId,
      smartCode:smartCode
    );
    ...
    if(result.success){//on success
      GetDriverController.run(context: context,nationalCode:driverNationalCode,recursive:false,mobileNumber:'');
    }
